            ...
            for(let h = 0;h<jiggler;h++){
                for(let t = 0;t<this.blocks.length;t++){
                    ...
                    // for(let k = 0;k<this.blocks.length;k++){
                        // if(t!= k){
                            if(this.blocks[t].hydrogen > 0 || this.blocks[t].carbon > 0 || this.blocks[t].oxygen > 0 || this.blocks[t].nitrogen > 0 || this.blocks[t].sulfur > 0 || this.blocks[t].phosphorous > 0 ){
                                if(this.blocks[t].glob.doesPerimeterTouch(this.blocks[index].glob)){
                                    if(!this.blocks[t].neighbors.includes(index)){
                                        this.blocks[t].neighbors.push(index)
                                        this.blocks[index].neighbors.push(t)
                                    ...
                                    let slpat = 4.5
                                    this.blocks[index].oxygen += this.blocks[t].oxygen/slpat
                                    this.blocks[t].oxygen -= this.blocks[t].oxygen/slpat
                                    if(this.blocks[t].oxygen < 20){
                                    ...
                                    let splot = 3.5
                                    this.blocks[index].nitrogen += this.blocks[t].nitrogen/splot
                                    this.blocks[t].nitrogen -= this.blocks[t].nitrogen/splot
                                    if(this.blocks[t].nitrogen < 20){
                                        this.blocks[t].nitrogen = 20
                                    }
                                    let splpt = 2.5
                                    this.blocks[index].phosphorous += this.blocks[t].phosphorous/splpt
                                    this.blocks[t].phosphorous -= this.blocks[t].phosphorous/splpt
                                    if(this.blocks[t].phosphorous < 20){
                                        this.blocks[t].phosphorous = 20
                                    }
                                    let splst = 3
                                    this.blocks[index].sulfur += this.blocks[t].sulfur/splst
                                    this.blocks[t].sulfur -= this.blocks[t].sulfur/splst
                                    if(this.blocks[t].sulfur < 20){
                                        this.blocks[t].sulfur = 20
                                    }
                                }
                            }else{
    ...
    class Atom{
        constructor(x,y, h,w, color){
            ...
            if(this.type == 14){
                if(Math.random()<.5){
                    this.kind = 1
                    this.oxygen = (Math.random()*500)+450
                    this.hydrogen = 0
                    this.spigot =2
                }else{
                this.oxygen = 0
            ...
            if(this.type == 15){
                ...
                this.kind = 1
                this.nitrogen = (Math.random()*200)+450
                this.spigot =4
            ...
            if(this.type == 16){
                ...
                if(Math.random()<.5){
                this.kind = 1
                this.phosphorous = (Math.random()*200)+450
                this.spigot =5
                this.sulfur = 0
                }else{
                    // console.log(this.body)
                this.kind = 1
                this.sulfur = (Math.random()*200)+450
                this.spigot =6
                this.phosphorous = 0
                }
            }else{
        ...
        getAtoms(){
            ...
            for(let t = 0;t<Math.ceil((this.hydrogen+this.oxygen+this.carbon+this.nitrogen)/50);t++){
        ...
        draw(){
            this.cleandots()
            this.body.color = `rgb(${(this.carbon/4)  + (this.nitrogen/8) + (this.sulfur/3.5)+ (this.phosphorous/4)}, ${(this.hydrogen/4)  + (this.nitrogen/3.5)+ (this.sulfur/3.5) }, ${(this.oxygen/4) + (this.nitrogen/5) + (this.phosphorous/8)})`
            this.body.draw()
